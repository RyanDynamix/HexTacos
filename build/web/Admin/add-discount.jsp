                                ...
                                <div class="card-body">
                                    ...
                                    <form action="adminDiscount" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="code" name="code" placeholder="Nhập mã giảm giá (VD: SALE20)" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên mã giảm giá" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="value" class="form-label">Giá trị <span id="valueType">(%)</span> <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" id="value" name="value" min="0" step="0.01" required>
                                                    <small class="text-muted" id="valueHint">Nhập giá trị phần trăm (1-100)</small>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="minOrderValue" class="form-label">Giá trị đơn hàng tối thiểu (VND) <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" id="minOrderValue" name="minOrderValue" min="0" value="0" required>
                                                </div>
                                            </div>
                                        </div>
